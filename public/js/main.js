...
!(function (e) {
    ...
    e("#preloader").fadeOut("normall", function () {
        ...
        a.on("scroll", function () {
            ...
            o <= 50
                ? (e("header").removeClass("scrollHeader").addClass("fixedHeader"), t.attr("src", "../img/logos/logo-inner.png"), s.attr("src", "../img/logos/logo.png"))
                : (e("header").removeClass("fixedHeader").addClass("scrollHeader"), t.attr("src", "../img/logos/logo.png"), s.attr("src", "../img/logos/logo.png"));
        }),
        (() => {
            let a = getComputedStyle(document.documentElement),
                ...
                s = () => {
                    ...
                    l.css("background", `conic-gradient(${o} ${i}%, ${t} ${i}%)`),
                        ...
                        i < 96 ? e("#scroll-value").text(`${i}%`) : e("#scroll-value").html('<i class="fa-solid fa-angle-up"></i>');
                };
            (window.onscroll = s),
                (window.onload = s),
        ...
        e(document).ready(function () {
            e(".testimonial-carousel1").owlCarousel({
                ...
                e(".testimonial-carousel2").owlCarousel({
                    ...
                    center: !1,
                    margin: 50,
                    responsive: { 0: { items: 1, margin: 0, nav: !1 }, 768: { items: 1, nav: !1 }, 992: { items: 1 }, 1200: { items: 1 } },
                }),
                ...
                e(".portfolio-carousel-one").owlCarousel({
                    ...
                    dots: !1,
                    margin: 30,
                    responsive: { 0: { items: 1, nav: !1 }, 576: { items: 2 }, 992: { items: 3 }, 1200: { items: 3 } },
                }),
                ...
                e(".slider-fade1").owlCarousel({
                    ...
                    animateIn: "fadeIn",
                    animateOut: "fadeOut",
                    responsive: { 0: { items: 1, nav: !1 }, 576: { items: 1, nav: !1 }, 768: { items: 1, nav: !1 }, 992: { items: 1, nav: !0 } },
                }),
                e(".owl-carousel").owlCarousel({ items: 1, loop: !0, dots: !1, margin: 0, autoplay: !0, smartSpeed: 500 }),
                e(".slider-fade1").on("changed.owl.carousel", function (a) {
                    ...
                    e("h1").removeClass("animated fadeInUp"),
                        ...
                        e(".owl-item").not(".cloned").eq(o).find("h1").addClass("animated fadeInUp"),
                        e(".owl-item").not(".cloned").eq(o).find("p").addClass("animated fadeInUp"),
                        e(".owl-item").not(".cloned").eq(o).find("a").addClass("animated fadeInUp");
                }),
                e(".countup").counterUp({ delay: 25, time: 2e3 }),
                e(".countdown").countdown({ date: "01 May 2028 00:01:00", format: "on" }),
