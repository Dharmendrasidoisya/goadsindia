...
class AdminController extends Controller
{
    ...
    public function AdminLogin(){
        ...
        return view('admin.admin_login',compact('settings'));
    } // End Mehtod 
...
public function AdminDestroy(Request $request){
    ...
    public function InactiveUser(){
        $inActiveUser = User::where('status','inactive')->where('role','user')->latest()->get();
    ...
    public function ActiveUser(){
        $ActiveUser = User::where('status','active')->where('role','user')->latest()->get();
    ...
    public function InactiveUserDetails($id){
        ...
        $inactiveUserDetails = User::findOrFail($id);
        return view('backend.user.inactive_user_details',compact('inactiveUserDetails'));
    ...
    public function ActiveUserApprove(Request $request){
        ...
        $notification = array(
         ...
         $vuser = User::where('role','user')->get();
        Notification::send($vuser, new UserApproveNotification($request));
    ...
    public function ActiveUserDetails($id){
        ...
        $activeUserDetails = User::findOrFail($id);
        return view('backend.user.active_user_details',compact('activeUserDetails'));
