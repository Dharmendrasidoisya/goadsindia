...
<head>
   ...
   <!--- Meta Title Start--->
      ...
      @if($categoryseo->isNotEmpty())
      @else
      <title>Kabra Trading Co.</title>
      @endif
  
      @foreach ( $categoryseo as  $categoryseos)
      @if($categoryseos->services_id !='id')
      <title> {{$categoryseos->meta_title}}</title>
  
          <meta name="description" content="{{$categoryseos->description}}" />
  
          <meta name="keywords" content="{{$categoryseos->keyword}}" /> 
  
          
  
                    <!-- Define x-default hreflang tag -->
        <link rel="alternate" href="{{$categoryseos->canonical}}" hreflang="x-default" />
              
          <link rel="canonical" href="{{$categoryseos->canonical}}" /> 
        
          <meta property="og:title" content="{{$categoryseos->meta_title}}">
          <meta property="og:description" content="{{$categoryseos->description}}">
          <meta property="og:image" content="{{$categoryseos->image}}">
          <meta property="og:url" content="{{$categoryseos->canonical}}">
          <meta property="og:type" content="website">
      
          <meta name="twitter:card" content="summary_large_image">
          <meta name="twitter:site" content="@sacrelifesciences">
          <meta name="twitter:title" content="{{$categoryseos->meta_title}}">
          <meta name="twitter:description" content="{{$categoryseos->description}}">
          <meta name="twitter:image" content="{{$categoryseos->image}}">
