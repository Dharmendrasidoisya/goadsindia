...
<!--- Meta Title Start--->
@if($productseos->isNotEmpty())
@else
      <title>Kabra Trading Co.</title>
@endif

@foreach ( $productseos as  $productsseo)
@if($productsseo->services_id !='id')
<title>{{$productsseo->meta_title}}</title>
<meta name="description" content="{{$productsseo->description}}" />
<meta name="keywords" content="{{$productsseo->keyword}}" />

<link rel="canonical" href="{{$productsseo->canonical}}" />
<!-- Define x-default hreflang tag -->
<link rel="alternate" href="{{$productsseo->canonical}}" hreflang="x-default" />

<meta property="og:title" content="{{$productsseo->meta_title}}">
<meta property="og:description" content="{{$productsseo->description}}">
<meta property="og:image" content="{{$productsseo->image}}">
<meta property="og:url" content="{{$productsseo->canonical}}">
<meta property="og:type" content="website">

<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:site" content="@sacrelifesciences">
<meta name="twitter:title" content="{{$productsseo->meta_title}}">
<meta name="twitter:description" content="{{$productsseo->description}}">
<meta name="twitter:image" content="{{$productsseo->image}}">
