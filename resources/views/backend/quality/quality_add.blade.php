...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Add Quality </div>
					<div class="ps-3">
...
<div class="col-lg-10">
	<div class="card">
		...
		<form id="myForm" method="post" action="{{ route('store.quality') }}" enctype="multipart/form-data" >
			@csrf
			...
			<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<textarea type="text" name="testimonial_description" id="editor1" class="form-control"></textarea>
				</div>
			</div>
