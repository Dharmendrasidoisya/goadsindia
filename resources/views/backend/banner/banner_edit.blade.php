		...
		<form id="myForm" method="post" action="{{ route('update.banner') }}" enctype="multipart/form-data" >
		 ...
		 <input type="hidden" name="old_img" value="{{ $banner->banner_image }}">
			...
			<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<textarea name="banner_description" class="form-control" id="editor1">{{ $banner->banner_description }}</textarea>
				</div>
			</div>
				...
				<div class="form-group col-sm-9 text-secondary">
					<textarea name="banner_longdescription" class="form-control" id="editor2">{{ $banner->banner_longdescription }}</textarea>
				</div>
			</div>
