...
<div class="col-lg-10">
	<div class="card">
		...
		<form id="myForm" method="post" action="{{ route('update.offer') }}" enctype="multipart/form-data" >
			@csrf
		 ...
		 <input type="hidden" name="old_img" value="{{ $banner->offer_image }}">
			...
			<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<input type="text" name="offer_title" class="form-control" value="{{ $banner->offer_title }}"   />
				</div>
			</div>
