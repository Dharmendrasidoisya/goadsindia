...
<div class="page-content"> 
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Add Product Category </div>
        <div class="ps-3">
                        ...
                        <div class="card-body">
                            <form id="myForm" method="post" action="{{ route('store.category') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-9 text-secondary">
										<textarea type="text" name="category_description" class="form-control" id="editor1"></textarea>
									</div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Category Image <span style="color:red;">*</span></h6>
                                    </div>
