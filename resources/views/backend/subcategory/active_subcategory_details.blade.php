...
<div class="page-content"> 
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">Active SubCategory Details</div>
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Active SubCategory Details</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="ms-auto">
...
<div class="col-lg-12">
    <div class="card">
        ...
        <form method="post" action="{{ route('active.subcategory.approve') }}" enctype="multipart/form-data" >
            @csrf
       ...
       <div class="row mb-3">
        ...
        <div class="row mb-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-9 text-secondary">
                    <input type="submit" class="btn btn-danger px-4" value="Inactive SubCategory" />
                </div>
            </div>
        </div>
