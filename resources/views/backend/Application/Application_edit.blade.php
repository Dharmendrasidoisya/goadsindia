...
<div class="page-content"> 
				...
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					<div class="breadcrumb-title pe-3">Edit Catalogue </div>
					<div class="ps-3">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb mb-0 p-0">
								<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
								</li>
								<li class="breadcrumb-item active" aria-current="page">Edit Catalogue </li>
							</ol>
						</nav>
					</div>
					<div class="ms-auto">
...
<div class="col-lg-10">
	<div class="card">
		...
		<form id="myForm" method="post" action="{{ route('update.application') }}" enctype="multipart/form-data" >
			@csrf
		 ...
		 <input type="hidden" name="old_image" value="{{ $category->category_image }}">
			...
			<div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					<input type="text" name="application_name" class="form-control" value="{{ $category->application_name }}"   />
				</div>
			</div>
			...
			{{-- <div class="row mb-3">
				...
				<div class="form-group col-sm-9 text-secondary">
					...
					<textarea name="application_description" class="form-control" id="editor1">{{ $category->application_description }}</textarea>
				</div>
			</div> --}}

			{{-- <div class="row mb-3">
				<div class="col-sm-3">
					<h6 class="mb-0">Catalogue Image </h6>
				</div>
			...
			{{-- <div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
                <img id="showImage" src="{{ asset($category->application_image)   }}" alt="Admin" style="width:100px; height: 100px;"  >
				</div>
			</div> --}}
			...
			<div class="row mb-3">
				...
				<div class="col-sm-9 text-secondary">
					...
					@if(!empty($category->application_pdf))
					<div class="mt-2">
						<a href="{{ asset($category->application_pdf) }}" target="_blank">Current PDF: {{ basename($category->application_pdf) }}</a>
					</div>
					@else
					<div class="mt-2">
						No PDF is uploaded
