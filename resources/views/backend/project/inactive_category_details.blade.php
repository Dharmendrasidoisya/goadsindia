...
<div class="page-content"> 
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">InActive Category Details</div>
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">InActive Category Details</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="ms-auto">
...
<div class="col-lg-12">
    <div class="card">
        ...
        <form method="post" action="{{ route('inactive.category.approve') }}" enctype="multipart/form-data" >
            @csrf
        ...
        <input type="hidden" name="id" value="{{ $inactiveAdminDetails->id }}">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                    <input type="text" class="form-control" name="division_name" value="{{ $inactiveAdminDetails->category_name }}"   />
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-sm-3">
                ...
                <div class="col-sm-9 text-secondary">
                    <input type="text" class="form-control" name="division_name" value="{{ $inactiveAdminDetails->category_description }}"   />
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9 text-secondary">
                 <img src="{{ (!empty($inactiveAdminDetails->category_image)) ? asset($inactiveAdminDetails->category_image): asset('upload/no_image.jpg')  }}" style="width: 70px; height:40px;" >
            ...
            <div class="row">
                ...
                <div class="col-sm-9 text-secondary">
                    <input type="submit" class="btn btn-danger px-4" value="active Category" />
                </div>
            </div>
        </div>
