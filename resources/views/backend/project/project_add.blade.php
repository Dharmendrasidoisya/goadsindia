                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="myForm" method="post" action="{{ route('store.project') }}"
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Product Category <span style="color:red;">*</span></h6>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Product Name <span style="color:red;">*</span></h6>
                                        </div>
                                        <div class="form-group col-sm-9 text-secondary">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <textarea type="text" name="project_description" class="form-control" id="editor1"></textarea>
                                        </div>

                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                            <h6 class="mb-0">Product Image <span style="color:red;">*</span></h6>
                                        </div>
